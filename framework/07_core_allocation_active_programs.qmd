---
title: "7. From core allocation to active programs"
---
...
#| echo: false
#| warning: false
#| fig-cap: "Left: cumulative wealth from 100 units invested at 7% gross annual return over 20 years, net of fees ranging from 5bps (passive) to 150bps (hedge fund equivalent). Right: cumulative fee drag relative to the passive baseline. The compounding effect of fees becomes the dominant performance driver over long horizons. An active manager must generate persistent gross alpha well above their fee just to match net returns. Source: Author calculations."
